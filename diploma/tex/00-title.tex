\begin{titlepage}
	...
	\begin{tabular}{p{0.23\textwidth}PPT}
		Студент &  ИУ7И-84Б & \uline{\undertext{\mbox{\hspace*{3cm}}}{Подпись, дата}} & Ахмад Халид Каримзай \\
		Руководитель & ~ &  \uline{\undertext{\mbox{\hspace*{3cm}}}{Подпись, дата}} & А.С. Кострицкий \\
		Нормоконтролер & ~ &  \uline{\undertext{\mbox{\hspace*{3cm}}}{Подпись, дата}} & - \\
	\end{tabular}
